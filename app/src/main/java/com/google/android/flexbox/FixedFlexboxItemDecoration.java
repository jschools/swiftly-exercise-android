 ...
 */
public class FixedFlexboxItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public FixedFlexboxItemDecoration(Context context) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
        ...
        FixedFlexboxLayoutManager layoutManager = (FixedFlexboxLayoutManager) parent.getLayoutManager();
    ...
    private void setOffsetAlongCrossAxis(Rect outRect, int position,
            FixedFlexboxLayoutManager layoutManager, List<FlexLine> flexLines) {
        if (flexLines.size() == 0) {
            return;
        }
    ...
    private void setOffsetAlongMainAxis(Rect outRect, int position,
            FixedFlexboxLayoutManager layoutManager, List<FlexLine> flexLines, int flexDirection) {
    ...
    private boolean isFirstItemInLine(int position, List<FlexLine> flexLines,
            FixedFlexboxLayoutManager layoutManager) {
        int flexLineIndex = layoutManager.getPositionToFlexLineIndex(position);
