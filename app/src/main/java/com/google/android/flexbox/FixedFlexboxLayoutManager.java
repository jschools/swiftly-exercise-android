 ...
 *
 * Swiftly edit:
 * This class has been copied from Flexbox in order to fix a bug. It must be used in combination
 * with other "FixedFlexbox*" classes in this package.
 */
public class FixedFlexboxLayoutManager extends RecyclerView.LayoutManager implements FlexContainer,
    ...
    private final FixedFlexboxHelper mFlexboxHelper = new FixedFlexboxHelper(this);
     ...
     */
    private FixedFlexboxHelper.FlexLinesResult mFlexLinesResult = new FixedFlexboxHelper.FlexLinesResult();
     ...
     */
    public FixedFlexboxLayoutManager(Context context, @FlexDirection int flexDirection) {
     ...
     */
    public FixedFlexboxLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                     int defStyleRes) {
     ...
     * i.e. {@link FixedFlexboxLayoutManager#getChildCount()} returns the child count, but it doesn't
     ...
     *
     * This method is used to avoid the implementation of the similar method.
     * i.e. {@link FixedFlexboxLayoutManager#getChildAt(int)} returns a view for the given index,
    ...
    /**
     * LayoutParams used by the {@link FixedFlexboxLayoutManager}, which stores per-child information
