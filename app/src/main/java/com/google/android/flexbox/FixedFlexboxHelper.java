 ...
 * {@link FlexboxLayout} and {@link FixedFlexboxLayoutManager}.
 *
 * Swiftly edit:
...
class FixedFlexboxHelper {
    ...
    FixedFlexboxHelper(FlexContainer flexContainer) {
     ...
     *                          {@link FixedFlexboxLayoutManager}, the calculation only needs the
    ...
    void calculateFlexLines(FlexLinesResult result, int mainMeasureSpec,
        ...
        for (int i = fromIndex; i < childCount; i++) {
            ...
            if (flexItem.getFlexBasisPercent() != FLEX_BASIS_PERCENT_DEFAULT
                ...
                // BEGIN Swiftly edit
                // change Math.round to int cast to avoid rounding up
                childMainSize = (int) (mainSize * flexItem.getFlexBasisPercent());
                // END
