...
package com.example.swiftly.exercise.android.specials.displaymodel
...
class DiscountedProductTileDisplayModel(
    val imageModel: NetworkImageModel,
    val title: String,
    val formattedPrice: String,
    val originalFormattedPrice: String,
    val aspectRatio: AspectRatioParams
)